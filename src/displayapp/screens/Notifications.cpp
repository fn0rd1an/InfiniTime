...
Notifications::NotificationItem::NotificationItem(const char* title,
  ...
  lv_obj_set_style_local_bg_color(container1, LV_CONT_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0x36104e));
  ...
  lv_obj_set_style_local_text_color(alert_type, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0x4c82a6));
  if (title == nullptr)
    title = "Notification";
  char* pchar;
  pchar = strchr(title, '\n');
  ...
  switch (category) {
    default: {
      ...
      lv_obj_set_style_local_text_color(alert_subject, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0x4c82a6));
